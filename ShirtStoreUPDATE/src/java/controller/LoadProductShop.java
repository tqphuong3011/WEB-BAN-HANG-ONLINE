...
//            double size = Double.parseDouble(sizeString);
            ...
            if (priceRange.equals("under100")){
                l1 = ShirtDB.getShirtByPrice(0L,100L);
                listShirt = ShirtDB.getShirtByPagePrice(0L,100L, pageNumber, pageSize);
            }
            else if (priceRange.equals("100to200")){
                l1 = ShirtDB.getShirtByPrice(100L,200L);
                listShirt = ShirtDB.getShirtByPagePrice(100L,200L, pageNumber, pageSize);
            }
            else if (priceRange.equals("200to300")){
                l1 = ShirtDB.getShirtByPrice(200L,300L);
                listShirt = ShirtDB.getShirtByPagePrice(200L,300L, pageNumber, pageSize);
            }
            else if (priceRange.equals("300to400")){
                l1 = ShirtDB.getShirtByPrice(300L,400L);
                listShirt = ShirtDB.getShirtByPagePrice(300L,400L, pageNumber, pageSize);
            }
            else{
                l1 = ShirtDB.getShirtByPrice(400L,1000000L);
                listShirt = ShirtDB.getShirtByPagePrice(400L,1000000L, pageNumber, pageSize);
            }
