 ...
 * @author admin
 */
@WebServlet(name = "LoadToCart", urlPatterns = {"/loadtocart"})
public class LoadToCart extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (u == null) {
            ...
            if (quantity<0){
                ...
                String ul = "loadtocart?action=RemoveCart&productID="+productID;
