    ...
    <body>
        ...
        <nav class="navbar navbar-expand-xl border-bottom border-dark"> 
            <div class="container-fluid">
                <a class="navbar-brand fs-3 fw-bold mx-3" href="/ShirtStoreTest" style="color: #006340">STOCK&STOCK</a>
                <div style="width:46%">
                ...
                <div class="collapse navbar-collapse ps-3" 
                    ...
                    <ul class="navbar-nav"> 
                        ...
                        <li class="nav-item"> 
                            <a class="nav-link text-dark fs-5 fw-semibold mx-1" href="/ShirtStoreTest"> 
                                Home
                            </a> 
                        </li> 
                        <li class="nav-item"> 
