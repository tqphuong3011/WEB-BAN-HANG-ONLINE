            ...
            <div class="container-fluid p-3" style="width: 28rem; margin-top: 4rem">
                ...
                <div class="container-fluid border p-4 bg-white">
                    <div class="text-center mb-4">
                        <span>Please check your email address
                            <br>to get the verification code.</span>
                    </div>
                    <form action="resetPass" method="post">
                        <div class="form-floating mb-2">
                            <input type="text" class="form-control rounded-0" id="email" placeholder="First Name" required name="verificationCode">
                            <label for="email" class="form-label required-field">Verification code</label>
                        </div>
                        <c:if test="${not empty message}">
                            <p class="alert alert-warning form-text fw-semibold"><i>${message}</i></p>
                                </c:if>
                        <input type="hidden" name="action" value="submitCode">
