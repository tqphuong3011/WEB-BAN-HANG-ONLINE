                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                <ul class="list-unstyled">
                                    <li class="text-muted"><i class="fas fa-user-alt"></i> To: <span style="color:#5d9fc5 ;">${invoice.user.fullName}</span></li>
                                    <li class="text-muted col-6 col-md-4 col-lg-4"><i class="fas fa-house-user"></i> Address: ${invoice.address.toString()}</li>
                                    <li class="text-muted"><i class="fas fa-phone"></i> Phone: ${invoice.user.phoneNumber}</li>
                                </ul>
                            </div>
                            <div class="col-xl-4">
