...
<div class="container p-3">
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" novalidate action="buyShirt" method="post">
                <c:if test="${promotion!=null}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="firstName" id="firstName" placeholder="A" value="" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="lastName" id="firstName" placeholder="Nguyen Van" value="" required>
                        <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" name="email" id="email" placeholder="abc@gmail.com" value="">
                    <div class="invalid-feedback">
