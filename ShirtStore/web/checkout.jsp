                    ...
                    <ul class="navbar-nav"> 
                        ...
                        <li class="nav-item"> 
                            <div class="d-flex flex-row align-items-center nav-link">
                                <button type="button" class="btn btn-outline-dark rounded-0 fw-semibold me-2" style="">Login</button>
                                <button type="button" class="btn btn-outline-dark rounded-0 fw-semibold me-2" style="">Sign&nbsp;Up</button>
                            </div>
                        </li>
                    </ul> 
                </div> 
            ...
            <form class="needs-validation" novalidate>
                ...
                <div class="row">
                    <div class="col-md-5 mb-3">
                        ...
                        <select class="custom-select d-block w-100 rounded-0" id="country" style="height:37.6px" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="custom-select d-block w-100 rounded-0" id="state" style="height:37.6px" required>
                            <option value="">Choose...</option>
