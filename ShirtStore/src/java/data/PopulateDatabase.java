...
//        abc123
        ...
        Category nikeCategory = new Category();
        nikeCategory.setCategoryName("Nike");
        nikeCategory.setCategoryID(56);

        Category yeezyCategory = new Category();
