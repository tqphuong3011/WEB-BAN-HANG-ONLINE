...
public class ShirtDB {
    ...
    public static List<Shirt> getShirtByPageSize(double size, int pageNumber, int pageSize) {
        EntityManager em = DBUtil.getEmFactory().createEntityManager();
        int offset = (pageNumber - 1) * pageSize;
    ...
    public static List<Shirt> searchShirtByName(String shoeName) {
        EntityManager em = DBUtil.getEmFactory().createEntityManager();

        try {
            String qString = "SELECT s FROM Shirt s WHERE LOWER(s.productName) LIKE :shoeName";
            TypedQuery<Shirt> query = em.createQuery(qString, Shirt.class);
            query.setParameter("shoeName", "%" + shoeName.toLowerCase() + "%");
    ...
    public static List<Shirt> searchShirtBySize(double size) {
        EntityManager em = DBUtil.getEmFactory().createEntityManager();
