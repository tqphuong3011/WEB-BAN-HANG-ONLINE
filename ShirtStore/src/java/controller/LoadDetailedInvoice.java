 ...
 * @author phuqu
 */
@WebServlet(name = "LoadDetailedInvoice", urlPatterns = {"/detailedInvoice"})
public class LoadDetailedInvoice extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Invoice invoice = InvoiceDB.getInvoiceById(iid);
