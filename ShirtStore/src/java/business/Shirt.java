...
public class Shirt implements Serializable {
    ...
    public Shirt(String productName, Category category, double productSize, String productColor, String productDecription, Long productPrice, List<sImage> images) {
    ...
    public Shirt(int productID, String productName, Category category, double productSize, String productColor, String productDecription, Long productPrice, List<sImage> images) {
